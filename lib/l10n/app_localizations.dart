...
abstract class AppLocalizations {
  ...
  /// name of Mosque- Madrassa Sultan Hassan
  ///
  /// In en, this message translates to:
  /// **'Mosque- Madrassa Sultan Hassan'**
  String get mosquehassanname;

  /// about description of Mosque- Madrassa Sultan Hassan
  ///
  /// In en, this message translates to:
  ...
  /// location of Al-Rifa'i Mosque
  ///
  /// In en, this message translates to:
  /// **'Salah El-Din Square, Islamic Cairo'**
  String get salaheldinlocation;

  /// first tag of Mosque- Madrassa Sultan Hassan
  ///
  /// In en, this message translates to:
  /// **'ISLAMIC'**
  String get mosquehassantag0;

  /// second tag of Mosque- Madrassa Sultan Hassan
  ///
  /// In en, this message translates to:
  /// **'MAMLUK'**
  String get mosquehassantag1;

  /// third tag of Mosque- Madrassa Sultan Hassan
  ///
  /// In en, this message translates to:
  /// **'ARCHITECTURE'**
  String get mosquehassantag2;

  /// name of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  /// **'Saint Catherine\'s Monastery'**
  String get saintcatherinemonasteryname;

  /// about description of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  ...
  /// city of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  /// **'South Sinai'**
  String get southsinai;

  /// first tag of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  /// **'Christian'**
  String get saintcatherinemonasterytag0;

  /// second tag of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  /// **'Monastery'**
  String get saintcatherinemonasterytag1;

  /// third tag of Saint Catherine's Monastery
  ///
  /// In en, this message translates to:
  /// **'PILGRIMAGE'**
  String get saintcatherinemonasterytag2;

  /// name of Mosque of al-Hakim bi-Amr Allah
  ///
  /// In en, this message translates to:
  /// **'Mosque of al-Hakim bi-Amr Allah'**
  String get mosqueofalhakimbiamrallahname;

  /// about description of Mosque of al-Hakim bi-Amr Allah
  ///
  /// In en, this message translates to:
  ...
  /// location of Al-Hussein Mosque
  ///
  /// In en, this message translates to:
  /// **'Khan El Khalili, Islamic Cairo'**
  String get almuizzstreetlocation;

  /// first tag of Mosque of al-Hakim bi-Amr Allah
  ///
  /// In en, this message translates to:
  /// **'FATIMID'**
  String get mosqueofalhakimbiamrallahtag0;

  /// second tag of Mosque of al-Hakim bi-Amr Allah
  ///
  /// In en, this message translates to:
  /// **'MOSQUE'**
  String get mosqueofalhakimbiamrallahtag1;

  /// third tag of Mosque of al-Hakim bi-Amr Allah
  ///
  /// In en, this message translates to:
  /// **'HERITAGE'**
  String get mosqueofalhakimbiamrallahtag2;

  /// name of Al-Hussein Mosque
  ///
  /// In en, this message translates to:
  /// **'Al-Hussein Mosque'**
  String get alhusseinmosquename;

  /// about description of Al-Hussein Mosque
  ///
  /// In en, this message translates to:
  ...
  /// first tag of Al-Hussein Mosque
  ///
  /// In en, this message translates to:
  /// **'ISLAMIC'**
  String get alhusseinmosquetag0;

  /// second tag of Al-Rifa'i Mosque
  ///
  /// In en, this message translates to:
  /// **'LANDMARK'**
  String get alhusseinmosquetag1;

  /// third tag of Al-Hussein Mosque
  ///
  /// In en, this message translates to:
  /// **'ARCHITECTURE'**
  String get alhusseinmosquetag2;

  /// name of Al-Rifa'i Mosque
  ///
  /// In en, this message translates to:
  /// **'Al-Rifa\'i Mosque'**
  String get alrifaimosquename;

  /// about description of Al-Rifa'i Mosque
  ///
  /// In en, this message translates to:
  ...
  /// first tag of Al-Rifa'i Mosque
  ///
  /// In en, this message translates to:
  /// **'OTHOMAN'**
  String get alrifaimosquetag0;

  /// No description provided for @alrifaimosquetag1.
  ///
  /// In en, this message translates to:
  /// **'MONSQUE'**
